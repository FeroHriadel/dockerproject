...
const pipelineStack = new PipelineStack(app, 'PipelineStack', {
  ...
  fargateServiceArn: ecsStack.fargateService.service.serviceArn,
  ecsClusterArn: ecsStack.ecsCluster.clusterArn,
  ecsClusterName: ecsStack.ecsCluster.clusterName,
